...
model=py.model_fastnet.generate_model(input_shape,categories,model_resnet18,layers,batch_size)
...
train_gen=py.prepare_data.dataGeneratorCoco(train,categories,coco_train,'./COCO2017',input_shape=input_shape,batch_size=batch_size)
val_gen=py.prepare_data.dataGeneratorCoco(val,categories,coco_val,'./COCO2017',input_shape=input_shape,mode='val',batch_size=batch_size)
