...
\usepackage{algorithmic}              % Paquete para algoritmos
...
\usepackage{tikz}
\usetikzlibrary{arrows,scopes,calc,babel}
...
\newcommand{\miTitulo}{Localización de Regiones de Interés Utilizando Aprendizaje Profundo\xspace}
\newcommand{\miNombre}{Laura Gómez Garrido\xspace}
\newcommand{\miGrado}{Grado en Ingeniería Informática y Matemáticas}
\newcommand{\miFacultad}{Facultad de Ciencias \\ Escuela Técnica Superior de Ingenierías Informática y de Telecomunicaciones \xspace}
\newcommand{\miUniversidad}{Universidad de Granada}
% Añadir tantos tutores como sea necesario separando cada uno de ellos
% mediante el comando `\\\medskip` y una línea en blanco
\newcommand{\miTutor}{
  Jesús Chamorro Martínez \\ \emph{Ciencias de la Computación e Inteligencia Artificial}
}
...
\input{preliminares/declaracion-originalidad}               % Opcional
...
\setpartpreamble[c][0.75\linewidth]{%
  ...
  En esta parte, introduciremos una serie de conceptos matemáticos necesarios para poder hablar con propiedad en adelante, así como una serie de teoremas relacionados con algunos de los términos. Explicaremos los conceptos de red neuronal y red neuronal convolucionada. Veremos que las redes neuronales son aproximadores universales y, además, veremos lo que es un operador no local, junto con su consistencia.
  %A continuación, explicaremos de forma concisa lo que es una \emph{red neuronal} y una \emph{red neuronal convolucionada} para, seguidamente, hablar sobre los últimos avances en la localización de regiones de interés en imágenes.
}
...
\setpartpreamble[c][0.75\linewidth]{%
	\bigskip % Deja un espacio vertical en la parte superior
  Se comentará algunas de las familias de redes neuronales convolucionadas más importantes para la segmentación semántica e instanciación de objetos. Se diseñarán y compararán diferentes modelos para comprobar la efectividad de operaciones no locales.
}
\part{Segmentación semántica}
\input{capitulos/capitulo2}

\setpartpreamble[c][0.75\linewidth]{%
	\bigskip % Deja un espacio vertical en la parte superior
  Se diseñará e implementara un sistema de recuperación de imágenes basado en su contenido.
}
\part{Desarrollo de un sistema CBIR}
...
\nocite{*} % FIXME cambiar conforme se vayan poniendo las referencias
