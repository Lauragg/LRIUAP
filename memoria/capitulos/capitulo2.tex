...
\begin{figure}[htpb]
  ...
  \caption{Entrenamiento del modelo mostrado en \autoref{fig:DiagramaNonlocalExtra} con aumento de datos en los datos de entrenamiento. $64$ canales en el bloque de atención. Conjunto de datos completo.}
  \label{fig:ejec10}
\end{figure}
\end{figure}
\begin{figure}[htpb]
